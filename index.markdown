...
<section class="section">
    <h2 class="section-label">Areas of Focus</h2>
    <div class="grid">
        <div class="card">
...
<section class="section">
    ...
    <div class="featured-projects">
        ...
        <a href="/projects/" class="featured-card">
            <div class="featured-card-inner">
                <span class="featured-tag">Python · OpenCV · PyTorch · YOLOv5</span>
                <h3>Dents & Scratches Detection</h3>
                <p>YOLOv5 object detection model trained for product surface defect detection — built for real-world QA usage at Whirlpool.</p>
                <span class="featured-link">All projects →</span>
            </div>
        </a>
    </div>
