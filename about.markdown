...
<section class="hero hero--compact">
    ...
    <h1 class="hero-headline">The work behind<br><em>the profile.</em></h1>
    <p class="hero-sub">A closer look at where I've worked, what I've actually built, and the tools I use to build it.</p>
</section>
...
<section class="section">
    ...
    <div class="timeline">
        ...
        <div class="timeline-item">
            <div class="timeline-date">Dec 2023 — April 2025</div>
        ...
        <div class="timeline-item">
            <div class="timeline-date">Sept 2022 — June 2023</div>
...
<section class="section">
    ...
    <div class="timeline">
        <div class="timeline-item">
            ...
            <p class="timeline-company">MIT World Peace University &nbsp;·&nbsp; Pune, MH</p>
            <p>CGPA: 9.60 / 10.0 &nbsp;·&nbsp; <strong>2nd Rank Holder</strong></p>
        </div>
        <div class="timeline-item">
            <div class="timeline-date">2016 – 2020</div>
            <h3>B.E. in Computer Engineering</h3>
            <p class="timeline-company">A. D. Patel Institute of Technology &nbsp;·&nbsp; Anand, GJ</p>
            <p>CGPA: 8.32 / 10.0</p>
        </div>
    </div>
</section>
